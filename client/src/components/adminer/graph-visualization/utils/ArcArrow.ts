...
export class ArcArrow {
    ...
    constructor(
        ...
        function startTangent(dr: number) {
        ...
        function angleTangent(angle: number, dr: number) {
            return {
        ...
        function endOverlayCorner(dr: number, dc: number) {
...
function intersectWithOtherCircle(
    fixedPoint: Point,
    radius: number,
    xCenter: number,
    polarity: number,
