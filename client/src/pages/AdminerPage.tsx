...
export function AdminerPage() {
    ...
    return (
        <div>
            ...
            <p className='text-muted-foreground italic'>Note: This page is a separate tool and was developed by my colleague. It is not part of my bachelor thesis implementation.</p>
