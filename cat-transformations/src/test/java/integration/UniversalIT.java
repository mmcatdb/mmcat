...
//	@Ignore
	public void testArrayOfRecords() {
		...
		try ( var mongoClient = MongoClients.create("mongodb://172.16.254.2:27017")) {
			...
			category.create("name", AbstractObjectType.ATTRIBUTE);
			category.create("price", AbstractObjectType.ATTRIBUTE);
...
//			category.create("test", AbstractType.RECORD);
			category.create("a", AbstractObjectType.ATTRIBUTE);
			category.create("b", AbstractObjectType.ATTRIBUTE);
			category.create("c", AbstractObjectType.ATTRIBUTE);
