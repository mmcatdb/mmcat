...
public interface AbstractSchema {
	...
	public void addAttribute(String domain, String codomain, Cardinality cardinality);
	...
	public void addAttribute(String parent, String current, String name, Cardinality cardinality);
