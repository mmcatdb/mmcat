...
import cz.matfyz.inference.algorithms.miner.functions.MapRawPropertyToKeyValuePairFunction;
import cz.matfyz.inference.algorithms.miner.functions.MapReduceRawPropertiesFunction;
import cz.matfyz.inference.algorithms.miner.functions.ProcessedPropertyFactory;
import cz.matfyz.inference.algorithms.miner.functions.ReduceRawPropertiesFunction;
...
public enum FootprinterLegacy {
	...
	public List<ProcessedProperty> process(AbstractInferenceWrapper wrapper, AbstractSeqFunction merge, AbstractCombFunction merge2,
