...
public abstract class Schema {
    ...
    public static final BuilderMorphism business_id =      builder.morphism(business, businessId);
    ...
    public static final BuilderMorphism business_ctgry =   builder.morphism(businessCategory, business);

    public static final BuilderMorphism user_id =          builder.morphism(user, userId);
    ...
    public static final BuilderMorphism user_friend =      builder.morphism(user, user); // TODO: maybe do double morphism with #role tag?

    public static final BuilderMorphism review_id =        builder.morphism(review, reviewId);
