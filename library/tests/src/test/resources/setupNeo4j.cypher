...
MATCH (a:Order { number: 'o_100' }), (b:Product { id: 'p_123' }) CREATE (a)-[r:ITEM { quantity: '1' }]->(b);
MATCH (a:Order { number: 'o_100' }), (b:Product { id: 'p_765' }) CREATE (a)-[r:ITEM { quantity: '2' }]->(b);
MATCH (a:Order { number: 'o_200' }), (b:Product { id: 'p_457' }) CREATE (a)-[r:ITEM { quantity: '7' }]->(b);
MATCH (a:Order { number: 'o_200' }), (b:Product { id: 'p_734' }) CREATE (a)-[r:ITEM { quantity: '3' }]->(b);
