...
/**
 * A path wrapper implementation for JSON files that implements the {@link AbstractPathWrapper} interface.
 * This class provides methods for managing and validating property paths within JSON data.
 */
