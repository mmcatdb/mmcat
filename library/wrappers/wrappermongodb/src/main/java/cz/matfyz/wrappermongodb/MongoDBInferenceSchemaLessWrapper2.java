...
import cz.matfyz.wrappermongodb.inference2.functions.MongoRawPropertyPairFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToDataRawPropertyFlatMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToFullRawPropertyFlatMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToPairFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToPropertiesMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToRSDMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToSchemaRawPropertyFlatMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRsdPairFunction;
import cz.matfyz.abstractwrappers.AbstractInferenceWrapper2;
import cz.matfyz.wrappermongodb.inference2.functions.MongoRecordToHeuristicsMapFunction;
import cz.matfyz.wrappermongodb.inference2.functions.MongoHeuristicsPairFunction;
 ...
 * @author pavel.koupil
 */
public class MongoDBInferenceSchemaLessWrapper2 extends AbstractInferenceWrapper2 {
	...
	public MongoDBInferenceSchemaLessWrapper2(String sparkMaster, String appName, String uri, String databaseName, String collectionName, String checkpointDir) {
	...
	public JavaPairRDD<String, RecordSchemaDescription> loadPropertySchema() {
        ...
        // moje
        @Override
        public MongoDBInferenceSchemaLessWrapper2 copy() {
            return new MongoDBInferenceSchemaLessWrapper2(
                    this.sparkMaster, 
                    this.appName, 
                    this.uri, 
                    this.databaseName, 
