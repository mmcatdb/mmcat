...
import cz.cuni.matfyz.querying.parsing.Filter;
import cz.cuni.matfyz.querying.parsing.StringValue;
import cz.cuni.matfyz.querying.parsing.Values;
...
public class QueryEngine {
    ...
    /**
     * Given a query plan with a compiled native query for each of its query parts, execute these native statements and save their results in an instance category in MM-evocat, returning this instance category.
