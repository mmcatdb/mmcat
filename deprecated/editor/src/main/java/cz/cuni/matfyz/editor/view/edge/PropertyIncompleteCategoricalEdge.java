 ...
 * @author pavel.koupil
 */
public class PropertyIncompleteCategoricalEdge extends Edge {
	...
	public PropertyIncompleteCategoricalEdge(String id, Cell source, Cell target) {
		super(source, target);
		...
		line.getStrokeDashArray().addAll(2d, 8d);
