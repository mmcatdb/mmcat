 ...
 * @author pavel.koupil
 */
public class MongoDBKindCell extends Cell {

	private static final double SIZE = 15;

	public MongoDBKindCell(String id, String name, double x, double y) {
		super(id);
		...
		shape.setStroke(CellColors.MONGODB_STROKE_COLOR);
		shape.setFill(CellColors.MONGODB_FILL_COLOR);
