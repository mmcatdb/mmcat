...
import type { LogicalModelFullFromServer, LogicalModelInfoFromServer, LogicalModelInit } from "@/types/logicalModel";

const logicalModels = {
    getLogicalModel: GET<{ id: StringLike }, LogicalModelFullFromServer>(
        u => `/logical-models/${u.id}`
    ),
    getAllLogicalModelsInCategory: GET<{ categoryId: StringLike }, LogicalModelFullFromServer[]>(
