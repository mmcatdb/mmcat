...
public class TestData {
    ...
    private SchemaCategory createInitialSchemaCategory() {
        ...
        var id_user = addSchemaObject(schema, id_userKey, "id_user", Id.Empty());
        var address = addSchemaObject(schema, addressKey, "address", new Id(addressToStreet, addressToCity));
        var street = addSchemaObject(schema, streetKey, "street", Id.Empty());
        var city = addSchemaObject(schema, cityKey, "city", Id.Empty());
        ...
        var id_order = addSchemaObject(schema, id_orderKey, "id_order", Id.Empty());
