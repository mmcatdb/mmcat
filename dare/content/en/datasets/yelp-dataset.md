...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  ...
  {{< open-link url="https://data.mmcatdb.com/dare/yelp/business.json" label="Data Link" >}}
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  ...
  {{< open-link url="https://data.mmcatdb.com/dare/yelp/user.json" label="Data Link" >}}
    <span style="margin: 0;"></span>
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  ...
  {{< open-link url="https://data.mmcatdb.com/dare/yelp/review.json" label="Data Link" >}}
    <span style="margin: 0;"></span>
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  ...
  {{< open-link url="https://data.mmcatdb.com/dare/yelp/tip.json" label="Data Link" >}}
    <span style="margin: 0;"></span>
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
  ...
  {{< open-link url="https://data.mmcatdb.com/dare/yelp/checkin.json" label="Data Link" >}}
    <span style="margin: 0;"></span>
